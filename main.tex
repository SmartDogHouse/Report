...
% Smart City Version
\def\SmartCity{0} % 1=True(SmartCity version (shorter)), 0=False(Full version)

    
\ifthenelse{\SmartCity=1}{ % SOLO per smart-city
...
\ifthenelse{\SmartCity=0}{ % NON per smart-city
