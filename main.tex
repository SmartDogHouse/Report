...
\ifx\SmartCity\undefined %if variable undefined
    % Smart City Version 
    \setcounter{SmartCity}{0} % <-- to switch versions CHANGE HERE, remember to PUT IT BACK TO 0, the website version is generated taking this variable
...
\newcounter{var}
\setcounter{var}{1} %1=True, usa la tabella ltx
\ifthenelse{\value{var}=1} {
    variable
}
\newcounter{test}
\setcounter{test}{1} %1=True, usa la tabella ltx
\ifthenelse{\value{test}=1} {
